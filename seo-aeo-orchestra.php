...
define('SEO_AEO_VERSION', '3.42.0-rc1');
...
register_activation_hook(__FILE__, function () {
    try {
        if (class_exists('SEO_AEO_Site_Scanner')) {
            SEO_AEO_Site_Scanner::scan_full(true);
        }
...
try {
    ...
    seo_aeo_safe_require(SEO_AEO_DIR . 'includes/class-action-dispatcher.php', 'class-action-dispatcher'); // 3.42.0-rc1 M2
