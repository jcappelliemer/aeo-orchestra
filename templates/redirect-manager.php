...
<div class="wrap orchestra-v3 orch-native-page">
    ...
    <div class="orch-native-hero">
        ...
        <div class="orch-native-hero-text">
            ...
            <h1 class="orch-native-hero-title"><?php echo class_exists('SEO_AEO_T') ? esc_html(SEO_AEO_T::t('Redirect Manager')) : 'Redirect Manager'; ?></h1>
            <p class="orch-native-hero-sub"><?php echo class_exists('SEO_AEO_T') ? esc_html(SEO_AEO_T::t('Tutto quello che serve per uscire da Yoast/RankMath/AIOSEO e gestire SEO + AEO direttamente da Orchestra. Output HTML, sitemap.xml, llms.txt, schema strutturato, redirect manager e AI 404 suggester.')) : 'Tutto quello che serve per uscire da Yoast/RankMath/AIOSEO e gestire SEO + AEO direttamente da Orchestra. Output HTML, sitemap.xml, llms.txt, schema strutturato, redirect manager e AI 404 suggester.'; ?></p>
        </div>
    </div>
    ...
    <div class="orch-native-quickstats">
        ...
        $seo_aeo_features = array(
            ...
            array('label' => 'Redirect Manager',     'enabled' => class_exists('SEO_AEO_Redirect_Manager') && SEO_AEO_Redirect_Manager::is_enabled(), 'icon' => '🔀', 'desc' => '301/302 + 404 log + AI'),
        );
    ...
    <div class="orch3-card orch-native-card" id="orch-output-card">
        ...
        <div class="orch-native-body">
            <div id="orch-native-redirect-section" class="orch3-muted" style="padding:8px 0;">
                <span class="rv-spinner"></span> <?php echo class_exists('SEO_AEO_T') ? esc_html(SEO_AEO_T::t('Caricamento Redirect Manager…')) : 'Caricamento Redirect Manager…'; ?>
            </div>
        </div>
    </div>

    <div class="orch-native-footer">
        <strong><?php echo class_exists('SEO_AEO_T') ? esc_html(SEO_AEO_T::t('Redirect Manager')) : 'Redirect Manager'; ?></strong> · <?php echo class_exists('SEO_AEO_T') ? esc_html(SEO_AEO_T::t('Versione')) : 'Versione'; ?> <?php echo esc_html(defined('SEO_AEO_VERSION') ? SEO_AEO_VERSION : '?'); ?> ·
...
<script>
    ...
    jQuery(function($) {
        ...
        $toggle.on('click', function() {
            ...
            if (!open && !loaded) loadRedirectStatus();
        });
        ...
        function renderStatus(s) {
            ...
            html += '<div id="orch-native-redirect-section"></div>';
